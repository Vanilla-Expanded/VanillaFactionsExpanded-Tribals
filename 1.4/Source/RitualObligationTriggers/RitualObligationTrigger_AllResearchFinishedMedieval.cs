...
{
    public class RitualObligationTrigger_AllResearchFinishedMedieval : RitualObligationTrigger
    {
        ...
        public override void Tick()
        {
            ...
            {
                if (GameComponent_Tribals.Instance.allMedievalResearchCompleted && Faction.OfPlayer.def.techLevel == TechLevel.Medieval)
                {
